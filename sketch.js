...
function collision(rock1, mango){
	...
	var distance = dist(rockBodyPosition.x, rockBodyPosition.x, mangoBodyPosition.x, mangoBodyPosition.y)
	
	if(distance <= mango.r + rock1.r){
		Matter.Body.setStatic(rock1.body,false);
	}
}